...
import clinicLogo from "../../../../assets/docpie_optical.jpg";
        ...
        <View style={styles.section}>
          ...
          <View style={styles.bodySignature}>
            ...
            <View style={styles.bodySignatureName}>
              <Text style={{ fontSize: 10, fontWeight: 700, marginRight: 12, marginTop: 5 }}>
                Dr. Sylvia Pamela Juan-Samiley
              </Text>
              <Text style={{ fontSize: 7, fontWeight: 400, marginRight: 40, marginTop: 5 }}>
                License No. 10398/135866
              </Text>
              <Text style={{ fontSize: 7, fontWeight: 400, marginRight: 96, marginTop: 5 }}>
                PTR No.
              </Text>
              <Text style={{ fontSize: 7, fontWeight: 400, marginRight: 101, marginTop: 5 }}>
                S2 No.
              </Text>
            </View>
          </View>

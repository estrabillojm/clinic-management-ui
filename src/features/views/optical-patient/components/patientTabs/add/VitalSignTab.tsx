...
const VitalSignTab = ({ selectedTab }: any) => {
  ...
  const data = {
    physicianRemarksHeight: 0,
    physicianRemarksWeight: 0,
    physicianRemarksBpSystolic: 0,
    physicianRemarksBpDiastolic: 0,
    physicianRemarksOxygenSaturation: 0,
    physicianRemarksTemperature: 0,
    physicianRemarksRespiratoryRate: 0,
    physicianRemarksPulseRate: 0,
    physicianRemarksBloodType: "",
    physicianRemarksVitalSignRemarks: "",
  }
